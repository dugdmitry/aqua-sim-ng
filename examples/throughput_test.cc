...
/*
 * Throughput test between two nodes:
 *
 * N -------> S
 *
 */
...
NS_LOG_COMPONENT_DEFINE("Throughput_test");
...
main (int argc, char *argv[])
{
  ...
  uint32_t m_packetSize = 5000; // bytes
...
//  asHelper.SetPhy("ns3::AquaSimPhyCmn");
  asHelper.SetPhy("ns3::AquaSimPhyMulti", "subchannel_bandwidth", DoubleValue (3000));
