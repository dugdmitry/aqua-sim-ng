...
AquaSimHeader::AquaSimHeader(void) :
    ...
    m_size(0), m_timestamp(0), m_protocol_number(0)
{
...
uint16_t
AquaSimHeader::GetProtoNumber(void)
{
  return m_protocol_number;
}
...
void
AquaSimHeader::SetProtoNumber(uint16_t protoNumber)
{
  m_protocol_number = protoNumber;
}
