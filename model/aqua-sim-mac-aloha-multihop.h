...
#ifndef AQUA_SIM_MAC_ALOHA_MULTIHOP_H
#define AQUA_SIM_MAC_ALOHA_NULTI_HOP_H
 ...
 */
class AquaSimAlohaMultihopAckRetry : public Timer
{
public:
  AquaSimAlohaMultihopAckRetry(Ptr<AquaSimAlohaMultihop> mac, Ptr<Packet> pkt)
    {
      m_mac = mac;
      m_pkt = pkt;
      m_id = m_idGenerator++;
    }
    AquaSimAlohaMultihopAckRetry() {}
    ~AquaSimAlohaMultihopAckRetry();
...
protected:
  Ptr<AquaSimAlohaMultihop> m_mac;
  Ptr<Packet> m_pkt;
  long	m_id;
 ...
 */
class AquaSimAlohaMultihop: public AquaSimMac
{
public:
  AquaSimAlohaMultihop();
  ~AquaSimAlohaMultihop();
  ...
  void	ProcessRetryTimer(AquaSimAlohaMultihopAckRetry* timer);
protected:
  ...
  std::map<long, AquaSimAlohaMultihopAckRetry*> RetryTimerMap_;   //map timer id to the corresponding pointer
...
#endif /* AQUA_SIM_MAC_ALOHA_MULTIHOP_H */
