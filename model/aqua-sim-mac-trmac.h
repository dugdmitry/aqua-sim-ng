...
#ifndef AQUA_SIM_MAC_TRMAC_H
#define AQUA_SIM_MAC_TRMAC_H
...
class AquaSimTrMac : public AquaSimMac
{
public:
  AquaSimTrMac();
...
private:
  ...
  // keep track of all the node ids, overheared during the TR-cycle
