  ...
  static TypeId tid = TypeId("ns3::AquaSimJammingMac")
      ...
      .AddTraceSource ("QueueSizeTrace",
                       "Trace current send-queue size",
                        MakeTraceSourceAccessor (&AquaSimJammingMac::m_queue_size), "ns3::Packet::TracedCallback")
      .AddTraceSource ("E2EDelayTrace",
                       "Trace current end-to-end delay of a packet",
                        MakeTraceSourceAccessor (&AquaSimJammingMac::m_e2e_delay), "ns3::Packet::TracedCallback")
    ;
  return tid;
}
...
AquaSimJammingMac::CreateSchedule(JammingMacScheduleType schedule_type)
{
  ...
  else if (schedule_type == AUCTION_SCHEDULE)
  {
    ...
    // std::ofstream input_file("/home/dmitrii/simulation2/coords.txt");
    ...
    // std::string str = "/home/dmitrii/simulation2/main > schedule.txt";
